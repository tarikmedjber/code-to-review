...
using MedjCap.Data.Infrastructure.Extensions;
        ...
        try
        {
            switch (correlationType)
            {
                case CorrelationType.Pearson:
                    coefficient = MathNetStats.Correlation.Pearson(measurementValues, atrMovements);
                    break;
                case CorrelationType.Spearman:
                    coefficient = MathNetStats.Correlation.Spearman(measurementValues, atrMovements);
                    break;
