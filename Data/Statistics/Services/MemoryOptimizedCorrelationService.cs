...
namespace MedjCap.Data.Statistics.Services;
...
public class MemoryOptimizedCorrelationService : ICorrelationService
{
    ...
    public CorrelationResult CalculateCorrelation(List<PriceMovement> movements, CorrelationType correlationType)
    {
        ...
        {
            CorrelationType.Pearson => MathNetStats.Correlation.Pearson(measurementArray.Array.Take(movements.Count), 
                                                          movementArray.Array.Take(movements.Count)),
            CorrelationType.Spearman => MathNetStats.Correlation.Spearman(measurementArray.Array.Take(movements.Count), 
                                                            movementArray.Array.Take(movements.Count)),
